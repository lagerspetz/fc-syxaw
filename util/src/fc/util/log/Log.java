...
/**
 * A singleton-like class for one-stop logging. This class provides a way to use
 * a single global {@link Logger} for all logging needs. The methods are the
 * same as in the {@link Logger} interface and delegate to the underlying
 * implementation. It is an error to call any other method of this class prior
 * to calling {@link #setLogger} with a non-{@code null} argument.
 * 
...
public class Log implements LogLevels {
    ...
    /**
         * The name of the system property for setting a logger. The value of
         * this property needs to be the name of a class having a no-argument
         * constructor. This constructor is called to create a default logger.
         * Note that setting this property overrides any loggers set by the
         * application.
         */
    ...
    /**
         * Set the logger to use. After this method is called, any call to the
         * other methods of this class will delegate to {@code logger}. Only the
         * first call of this method has any effect.
         * 
         * @param logger the logger to use from now on
         */
