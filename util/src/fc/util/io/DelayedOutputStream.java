			...
			public void run() {
				try {
					...
					delayedEx = x;
				    	...
				    	// BUGFIX-20061130-1: used wrong this instance in
				    	// expressions below (.this instead of DelayedOutputStream.this
				    	synchronized (DelayedOutputStream.this) {
				    	    consumerDone = true;
				    	    DelayedOutputStream.this.notify();
					}
