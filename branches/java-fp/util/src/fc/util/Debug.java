...
public class Debug {
	...
	WeakReference /*!5 <Object> */ wr = new WeakReference /*!5 <Object> */ (tester);
	tester = null;
	gcLoop(wr);
    ...
    private static void gcLoop(WeakReference /*!5 <Object> */ wr) {
	for( int i = 0;i<256;i++) {
	    Util.runGc();
	    if( wr.get() == null ) {
	...
	private static Stack /*!5 <Object> */ anonymous = 
	    new Stack /*!5 <Object>*/();

	private static Map /*!5 <Object,Long> */ timeStamps= 
	    new WeakHashMap /*!5 <Object,Long> */();
	...
	public static long stamp(Object handle) {
	    Long l = (Long) timeStamps.put(handle,
				    new Long(System.currentTimeMillis()));
	    return l == null ? NO_TIME : l.longValue();
	}
	...
	public static long get(Object handle) {
	    Long l = (Long) timeStamps.get(handle);
	    return l == null ? NO_TIME : l.longValue()-zero;
	}
	...
	public static long since(Object handle) {
	    Long l = (Long) timeStamps.get(handle);
	    return l == null ? NO_TIME : System.currentTimeMillis()-
		l.longValue();
	}
	...
	private static Map /*!5 <Object,Long> */ values= 
	    new WeakHashMap /*!5 <Object,Long> */ ();
	...
	public static long set(Object handle, long val) {
	    Long l = (Long) values.put(handle, new Long(val));
	    return val;
	}
	 ...
	 */
	public static long get(Object handle) {
	    Long l = (Long) values.get(handle);
	    if( l == null ) {
		return Time.get(handle);
	    }
	    return l.longValue()-bias;
	}
