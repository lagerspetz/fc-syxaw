...
/**
 * A class of static general utility methods. This class collects miscellaneous
 * useful methods to one class. No instances of this class can be created.
...
public final class Util {
    ...
    /**
         * Compare two objects for equality. This method does the right thing in
         * case one, or both, of the objects is <code>null</code>.
         */
    ...
    /**
         * Get a hash code for an object. The return value is <code>0</code>
    ...
    public static <E> Iterable<E> iterable(final Iterator i)  {
