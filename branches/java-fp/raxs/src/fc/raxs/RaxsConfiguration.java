...
public abstract class RaxsConfiguration extends AbstractDictionary implements
   ...
   * @throws IOException
   */
  public static RaxsConfiguration getConfig(Class /*!5 <? extends Store> */ s, File f) 
  throws IOException {
    if( f.isDirectory() ) {
  ...
  public static RaxsConfiguration getConfig(Class /*!5 <? extends Store> */ st) {
  ...
  public Store createStore() throws ParseException {
    ...
    try {
      Class /*!5 <Store> */ sclass = (Class /*!5 <Store> */) Class.forName(sclassS);
      Constructor /*!5 <Store> */ c = sclass.getConstructor(
          new Class[] {StoreConfiguration.class});
      return (Store) c.newInstance(new Object[] {this});
  ...
  private static class StoreCodec implements XasCodec {
    ...
    public void encode(ItemTarget t, RefTreeNode n, StartTag context) throws IOException {
      ...
      //A! assert n.getContent() instanceof RaxsConfiguration;
  ...
  private static class DefaultConfig extends RaxsConfiguration {
    ...
    private SortedMap /*!5 <String,String> */ vals = 
       new TreeMap /*!5 <String, String> */();
   private TreeModel tm=null;
    ...
    public DefaultConfig(Class /*!5 <? extends Store> */ st, File root, 
