...
public abstract class XasStore extends Store {
  ...
  public abstract static class LazySource implements RandomAccessSource /*!5 <Key> */ {
    public abstract Item getLazyTree(Key k) throws NodeNotFoundException, IOException;
  }
