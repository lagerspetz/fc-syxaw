 ...
 * 
 */
public interface RandomAccessSource /*5! <E extends Key> */ extends ItemSource {

  /** Get source root key.
   * 
   * @return root key
   */
  public /*!5 E */ Key getRoot();
  
  /** Get parent key.
   * 
   * @param k key to get parent for
   * @return parent key of <i>k</i>
   * @throws NodeNotFoundException if <i>k</i> is not present
   */
  public /*!5 E */ Key getParent(Key k) throws NodeNotFoundException;
   ...
   * 
   * @param k key to get child keys for
   * @return iterator of child keys
   * @throws NodeNotFoundException if <i>k</i> is not present
   */
  public Iterator /*!5 <E> */ getChildKeys(Key k) throws NodeNotFoundException;
  
  /** Seek source to a given key.
   * 
   * @param k key to seek to
   * @throws NodeNotFoundException if <i>k</i> is not present
   */
  public void seek(/*!5 E */ Key k) throws NodeNotFoundException;
