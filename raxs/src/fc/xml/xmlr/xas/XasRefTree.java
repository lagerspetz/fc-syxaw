...
public class XasRefTree implements IdAddressableRefTree {
  ...
  protected RandomAccessSource /*!5 <Key> */ source;
   ...
   */
  public XasRefTree(RandomAccessSource /*!5 <? extends Key> */ source, 
      UniformXasCodec tm) {
    this.tm = tm;
    this.source = source; 
  }
  ...
  protected class XasNode implements RefTreeNode {
    ...
    public Iterator getChildIterator() {
      try {
        final Iterator /*!5 <Key> */ cki = source.getChildKeys(k);
        return new Iterator() {
  ...
  protected void trap(Exception e) {
    ...
    if( !(e instanceof IOException) ) {
      IOException ee = new IOException("Trapped exception: "+e.getMessage());
      //NOTINFPee.initCause(e);
      e = ee;
    }
    if(trap != null) 
