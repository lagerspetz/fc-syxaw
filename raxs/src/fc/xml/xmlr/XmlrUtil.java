...
public class XmlrUtil {
  ...
  private static int countNodes(RefTreeNode root, int i) {
    i++;
    for( Iterator /*!5 <RefTreeNode> */ it = root.getChildIterator();it.hasNext();)
      i=countNodes((RefTreeNode) it.next(),i);
    return i;
  }
  ...
  public static final class SmallLRUCache  {
    ...
    public static void main(String[] args) {
      ...
      //A! assert c.get(keys[0]) == null; // Verify cold key was lost
      //A! assert c.get(keys[8]) == vals[8]; // Verify warm key was kept
    }*//*
