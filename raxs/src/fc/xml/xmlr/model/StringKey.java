...
public class StringKey implements Key {
  ...
  /** Create a new key. The returned key is the concatenation of 
   * the parent key and the suffix.
   * 
  ...
  public boolean equals(Object obj) {
    // NOTE: We don't want equals to succeed with String, because we can't make
    // String.equals succeed with StringKey -- i.e., we could make things
    // more convenient one way, but at the risk of introducing strange behavior
    if( obj instanceof String )
      Log.warning("StringKey being compared to String",obj);
    return obj instanceof StringKey &&
      Util.equals(((StringKey) obj).key,key);
  }
  ...
  /** A unique string key. Instances of this key will always be
   * unique, assuming <code>System.identityHashCode(o)</code>
   * is unique for any Object <i>o</i>.
   * 
   */
