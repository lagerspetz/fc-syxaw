...
public interface NodeModel {
   ...
   * 
   * @param parent parent node, or <code>null</code> if this is a new root
   * @param key key of the node
   * @param content content of the node. May be an instance of 
   * {@link fc.xml.xmlr.Reference}, in which case the node should be a reference
   * node
   * @param pos position in the child list of <i>parent</i>. May be
