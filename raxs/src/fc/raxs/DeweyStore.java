...
import fc.raxs.IdStore.IdSource;
...
public class DeweyStore extends XasStore implements IOExceptionTrap {
  ...
  protected class DeweySource extends LazySource {
    ...
    public /*!5 Dewey */Key getParent(Key k) throws NodeNotFoundException {
    ...
    public Iterator /*!5 <Key> */ getChildKeys(Key dk) 
    ...
    protected fc.xml.xas.index.DeweyKey iseek(Key k1) throws NodeNotFoundException {
      ...
      try {
        if (k.isRoot()) {
          ...
          currentPos = (FragmentPointer) r.query(k.deconstruct());
        }
      } catch (IOException e) {
        trap(e);
      }
